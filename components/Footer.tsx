      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Het slimste teambuilding platform van België. AI-gestuurd,
              eenvoudig en professioneel.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="text-white/50 transition-colors hover:text-[#1D9E75]"
                aria-label="LinkedIn"
              >
                <LinkedInIcon />
              </a>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center">
          <p className="text-sm text-white/40">
            &copy; 2026 Dagout.be — Het slimste teambuilding platform van België
          </p>
        </div>
      </div>
    </footer>
